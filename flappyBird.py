...
#bg_surface = pygame.transform.scale2x(pygame.image.load('assets/background-day.png'))
...
while True:
	...
	screen.blit(bg_surface,(0,0)) # Display Surface (coordinate system is inversed)
	if game_active:
	...
	pygame.display.update() # updates newly created images
	clock.tick(75) # not more than 120 frames persecond